#!/bin/bash
# Coded by: altoid (Don't change, noob!)
...
printf "\e[1;95m                          .-        -.         \e[0m\n"
printf "\e[1;95m                         /SnapCracker \         \e[0m\n"
printf "\e[1;95m                           ---------             \e[0m\n"
printf "\e[1;95m                        |,  .-.  .-.  ,|         \e[0m\n" 
...
printf "\e[1;91m                   SnapCracker (Telegram-Alt_Gr)  \e[0m\n" 
}


function start() {
read -p $'\e[1;92mserenity244827 account: \e[0m' user
